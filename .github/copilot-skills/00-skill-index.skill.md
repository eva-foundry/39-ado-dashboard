...
# Skill Index -- ADO Sprint Dashboard

> This is the skills menu for 39-ado-dashboard.
...
**Goal**: Real-time ADO sprint board and velocity dashboard for EVA Platform programme leads
**37-data-model record**: `GET /model/projects/39-ado-dashboard`
