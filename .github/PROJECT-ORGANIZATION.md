...
<!-- Placeholders: 39-ado-dashboard = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 39-ado-dashboard - Organization Standards
